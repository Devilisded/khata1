...
const [select,setSelect]=useState(false);
  return (
    ...
    <Box sx={{ width: 400 }} role="presentation">
      <h1 className="text_left heading font-semibold text-2xl flex justify-between items-center">Add Supplier</h1>
...
size="small"
              ...
              {isChecked2 ? (
                <Box
                  ...
                  className="box-sec-2"
                >
                  <p className="text_left text-xl font-semibold">Billing Address</p>
                  <Box className="box-sec">
                    <TextField
                      id="outlined-basic"
                      label="Flat / Building Number"
    ...
    <button className="text-green-600 bg-green-200 w-full p-3 rounded-[5px] hover:text-white hover:bg-green-600 transition-all ease-in" onClick={props.snack} >Add Supplier</button>
  </div>
    </div>
  )
}
