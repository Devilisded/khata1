...
const AddSales = (props) => {
  ...
  .map((item) => parseFloat(item.in_qty) * (parseFloat(item.in_discount_price) + parseFloat(item.in_gst_amt ? item.in_gst_amt : 0)))
  .reduce((acc, current) => {
    return acc + current;
  }, 0);
                  ...
                  >
                                ...
                                <div className="flex justify-between border-b p-3 ">
                                  ...
                                  <div>
                                    <p className=" font-[500] text-lg">
                                      ...
                                      {(
                                        item.in_qty *
                                        ((item.in_discount_price ? item.in_discount_price : 0) +
                                        item.in_gst_amt
                                          )
                                      ).toFixed(2)}
                    ...
                    <Box className="box-sec">
                      <TextField
                        label="Amount Paid"
                        name="amount_paid"
                        value={totalGrossValue > 0 ? totalGrossValue : "0"}
                        id="outlined-basic"
                        variant="outlined"
                        className="w-full"
                        size="small"
